...
assert('11 endless ladder writes send [w.ts | 0, w.build | 0] (found ' + withBuild.length + ' of ' + writes.length + ' SetLeaderboardScore details writes; +2 quad +2 casual solo, client knife 3.7a)', withBuild.length === 11);
